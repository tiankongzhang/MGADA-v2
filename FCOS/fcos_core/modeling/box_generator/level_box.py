...
class BoxGenModule(torch.nn.Module):
    ...
    def forward(self, images, features, targets=None, return_maps=False):
        ...
        if self.training:
            ...
            return self._forward_test(locations, box_regression, images.image_sizes, targets=targets)
    ...
    def _forward_test(self, locations, box_regression, image_sizes, targets=None):
        score_maps = {
            "box_regression": box_regression
        }
